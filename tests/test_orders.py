...
class TestOrders:
    ...
    """
    Проверяем позитивный сценарий через кнопку "Заказать" вверху страницы и
    ...
    """
    Проверяем: если нажать на логотип «Самоката», попадёшь на главную страницу «Самоката».
    """
    ...
    """
    Проверяем позитивный сценарий через кнопку "Заказать" внизу страницы и
    появление всплывающего окна с сообщением об успешном создании заказа.
    """
    ...
    """
    Проверяем: если нажать на логотип Яндекса, в новом окне через редирект откроется главная страница Дзена.
    """
